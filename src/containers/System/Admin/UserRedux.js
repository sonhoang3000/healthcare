...
class UserRedux extends Component {
      ...
      async componentDidMount() {
            this.props.getGenderStartRedux();
            this.props.getPositionStartRedux();
            this.props.getRoleStartRedux();
      }
      ...
      handleSaveUser = () => {
            let userValid = this.checkValidateInput();
...
const mapDispatchToProps = dispatch => {
      return {
            getGenderStartRedux: () => dispatch(actions.fetchGenderStart()),
            getPositionStartRedux: () => dispatch(actions.fetchPositionStart()),
            getRoleStartRedux: () => dispatch(actions.fetchRoleStart()),
